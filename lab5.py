...
def nom4():
    import random
    group1 = ["Хомяков", "Соколова", "Васильев", "Казаков", "Одинцов", "Озеров", "Киселева", "Соловьева", "Кузнецов", "Петров"]
    group2 = ["Гусев", "Кузнецов", "Куприянов", "Филиппов", "Воронов", "Дулина", "Любимов", "Жилин", "Михайлова", "Иванов"]
    x = list(range(10))
    random.shuffle(x)
    y = list(range(10))
    random.shuffle(y)
